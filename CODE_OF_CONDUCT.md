...
Guardana and its community a harassment-free experience for everyone,
...
reported to the project team at **contact@guardana.dev** or through
[karauda.com/contact](https://karauda.com/contact). All complaints
will be reviewed and investigated promptly and fairly, and all project
...
1. **Correction** — A private, written warning for an inappropriate but
   likely unintentional violation.
2. **Warning** — A warning with consequences for continued behavior,
   including no interaction with those involved for a specified period.
