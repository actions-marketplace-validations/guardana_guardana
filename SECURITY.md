...
gh attestation verify oci://ghcr.io/guardana/guardana:0.25 --repo guardana/guardana
docker buildx imagetools inspect ghcr.io/guardana/guardana:0.25 --format '{{ json .SBOM }}'
```
...
Guardana is pre-1.0 (0.25.x). Security fixes land on the latest released
